  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-9">
        <button
          type="submit"
          className="flex w-full cursor-pointer items-center justify-center rounded-md border border-primary bg-primary px-5 py-3 text-base text-background transition duration-300 ease-in-out hover:opacity-90"
        >
          Send Magic Link
        </button>
      </div>
