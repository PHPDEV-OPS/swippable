      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='mb-4'>
          <input
            ...
            type='text'
            name='price'
            className='text-white bg-transparent border border-border rounded-md px-3 py-2 w-full focus:border-primary focus-visible:outline-0'
        ...
        <button className='hover:text-white font-medium text-lg bg-transparent w-full border border-primary rounded-lg py-3 text-primary hover:bg-primary transition-all cursor-pointer'>
          Sell
        </button>
      </form>
    </div>
